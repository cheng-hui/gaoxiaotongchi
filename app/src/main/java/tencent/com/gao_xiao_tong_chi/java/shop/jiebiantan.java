...
import tencent.com.gao_xiao_tong_chi.java.houduan.DBFormat;
import tencent.com.gao_xiao_tong_chi.java.houduan.GsonUtil;
       ...
       // initShopsnot();
        ...
        private void initShopsnot() {
           // String name, String headId, int starId,String distance)
            Shop zlmlt = new Shop("张亮麻辣烫","33",a,"距离您1.5公里");
            shopList.add(zlmlt);
            Shop dbsj = new Shop("东北水饺", "33",a,"距离您2.0公里");
            shopList.add(dbsj);
            Shop nrbdx = new Shop("牛肉爆大虾", "33",a,"距离您3.0公里");
            shopList.add(nrbdx);
        }
    //从后端获取数据并传入LISTVIEW
